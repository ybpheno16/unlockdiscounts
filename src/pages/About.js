  ...
  return (
    <div className="about-container">
      <div className="about-left-side">
        <h1>About</h1>
        <h4>
          Unlock Discounts: Where Savings Meet Style & Smart Banking Solutions!
        </h4>
        <p>
          Welcome to Unlock Discounts - your go-to destination for incredible
          deals on a variety of products! We specialize in offering high-quality
          affiliate items at unbeatable prices, ensuring you save big with every
          purchase. From fashion essentials like women's, men's, and kids' wear
          to cutting-edge electronics including phones, accessories, home, and
          healthcare appliances, we've got everything you need to upgrade your
          lifestyle affordably.
        </p>
        <p>
          But that's not all - we're more than just a shopping hub. Unlock
          Discounts also provides essential banking services, offering the best
          credit cards, zero savings accounts, and top-saving applications to
      ...
      <div className="contact-left-side">
        ...
        <p>
          ...
          order, or just want to say hello, we're here to help. Join our
